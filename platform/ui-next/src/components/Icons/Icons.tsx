...
import Print from './Sources/Print';
...
export const Icons = {
  ...
  'tool-download-detailed': (props: IconProps) => ToolDownloadDetailed(props),
  ...
  'icon-print': (props: IconProps) => Print(props),
