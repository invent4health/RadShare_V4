...
const Thumbnail = ({
  ...
  // if (excludedmodaloities.includes(modality) && excludedmodaloities.length > 0) {
  //   console.log('Excluding modality: ', modality);
  //   return null;
  // }
        ...
        <div className="h-[114px] w-[128px]">
          <div className="relative">
            {imageSrc ? (
              ...
              <div className="bg-background h-[114px] w-[128px] rounded"> No image found </div>
            )}
