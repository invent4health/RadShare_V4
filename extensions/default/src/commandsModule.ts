                  ...
                  React.createElement(
                    'button',
                    {
                      ...
                      onClick: async () => {
                        ...
                        const zipUrl =
                          (window as any).dicomZipUrl ||
                          localStorage.getItem('dicomZipUrl') ||
                          'http://102.67.142.34:8084/dcm4chee-arc/aets/RADSHARE/rs/studies/1.2.410.200059.11.1.100.20250813183017910.6281?accept=application/zip';
                        if (zipUrl) {
                          try {
                            const backendBase =
